<?php 
    ...
    //  $sql1 = "SELECT categories.*, subcategories.category_id as cid, subcategories.name as sname
				// FROM categories 
	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
				...
				<img src="logo/shop_logo_big.png" style="height: 100px" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none">

				<img src="logo/shop_logo_big.png" style="height: 50px" class="img-fluid d-xl-none d-lg-none d-md-inline d-sm-none d-none">

				<img src="logo/shop_logo_big.png" style="height: 40px" class="img-fluid d-xl-none d-lg-none d-md-none d-sm-inline d-inline pl-2" style="width: 30px">
			</div>
				            	...
				            	<h6 class="dropdown-header">
				            		<?= $name; ?>
				              		...
				              		foreach ($results as $result) {
				              		 ...
				              		 ?>
				              			<li>
				              				<a class="dropdown-item" href="subcategory.php?id=<?=$id;?>">
				              					<?= $result['name']?>
				              				</a>
				              			</li>
				              			<?php }; ?>
				...
				<div class="hov-dropdown d-inline-block">
          			...
          			<div class="dropdown-menu" aria-labelledby="navbarDropdown2">
          				<?php 
          					...
          					$stmt->execute();
          					$marchants = $stmt->fetchAll();
          					foreach ($marchants as $marchant):
          						$mar_id = $marchant['id'];
          						$mar_name = $marchant['name'];
          				 ?>
            			<a class="dropdown-item" href="brand.php?id=<?= $mar_id; ?>"><?= $mar_name; ?></a>
            			<div class="dropdown-divider"></div>
     					<?php endforeach; ?>
          			</div>
        		</div>
